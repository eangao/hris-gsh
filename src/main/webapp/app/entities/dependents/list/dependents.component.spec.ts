...
describe('Dependents Management Component', () => {
  let comp: DependentsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DependentsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dependents?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
