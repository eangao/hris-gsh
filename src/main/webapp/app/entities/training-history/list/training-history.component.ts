...
export class TrainingHistoryComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.trainingHistoryService
      ...
      .subscribe(
        (res: HttpResponse<ITrainingHistory[]>) => {
  ...
  delete(trainingHistory: ITrainingHistory): void {
    const modalRef = this.modalService.open(TrainingHistoryDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.trainingHistory = trainingHistory;
