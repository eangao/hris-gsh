...
describe('TrainingHistory Management Component', () => {
  let comp: TrainingHistoryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TrainingHistoryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.trainingHistories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
