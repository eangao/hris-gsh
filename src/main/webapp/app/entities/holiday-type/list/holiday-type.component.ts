...
export class HolidayTypeComponent implements OnInit {
  ...
  protected onSuccess(data: IHolidayType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/holiday-type'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
