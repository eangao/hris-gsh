...
/**
 * Criteria class for the {@link com.hrisgsh.app.domain.Designation} entity. This class is used
 * in {@link com.hrisgsh.app.web.rest.DesignationResource} to receive all the possible filtering options from
...
public class DesignationCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, employeeId, distinct);
    }
