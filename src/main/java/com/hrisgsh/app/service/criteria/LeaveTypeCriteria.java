...
/**
 * Criteria class for the {@link com.hrisgsh.app.domain.LeaveType} entity. This class is used
 * in {@link com.hrisgsh.app.web.rest.LeaveTypeResource} to receive all the possible filtering options from
...
public class LeaveTypeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, leaveId, distinct);
    }
